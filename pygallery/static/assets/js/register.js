...
function validatepassword() {
    if (input.value != "") {
        ...
        if (no == 1) {
            ...
            text.textContent = "Простой пароль, усложните";
            text.classList.add("weak");
        }
        if (no == 2) {
            medium.classList.add("active");
            text.textContent = "Добавьте еще символов";
...
function confirmpw() {
    if (cpass.value != "") {
        ...
        if (cpass.value != input.value) {
            cpassText.innerHTML = "Пара паролей не совпадает";
            ...
            // cpassText.type="text";
            cpassText.textContent = "Пароли совпадают";
